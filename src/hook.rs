...
static INT64_OFFSET: usize = 0x4e53b0; // 13.0.3
static INT_OFFSET: usize = 0x4e53a0; // 13.0.3
static FLOAT_OFFSET: usize = 0x4e53e0; // 13.0.3
static SET_ID_EARLY: usize = 0x6079d0; // 13.0.3
...
#[skyline::hook(offset = SET_ID_EARLY)]
pub unsafe extern "C" fn set_entry_id_early(fighter: &mut Fighter, battle_object_id: u32, kind: i32, entry_id: i32, hash: smash::phx::Hash40) {
    let module_accessor = fighter.battle_object.module_accessor;
    WorkModule::set_int(module_accessor,entry_id, *FIGHTER_INSTANCE_WORK_ID_INT_ENTRY_ID);
    original!()(fighter, battle_object_id, kind, entry_id,hash)
}


#[skyline::hook(offset=INT64_OFFSET)]
pub unsafe fn get_param_int_64_hook(module: u64, param_type: u64, param_hash: u64) -> i64 {
